...
public class Doctor extends User {
	...
	public Doctor(){
		this.patients = null; //This will have to read from the database when the program loads? 
	}
	...
	{
		//This will need to look at the database and return the info of the patient with the email searched.
	}
